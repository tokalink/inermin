...
const executeBulkAction = (actionName) => {
  ...
  if (confirm(`Are you sure you want to execute action "${actionName}" on selected items?`)) {
    router.post(window.location.pathname + '/action-selected', {
...
const deleteRow = (id) => {
  if (confirm('Are you sure you want to delete this row?')) {
    router.get(window.location.pathname + '/delete/' + id)
  }
}
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-2 flex-wrap">
          <Link
            ...
            :href="window.location.pathname + '/add'"
          ...
          <a
            ...
            :href="window.location.pathname + '/export-data'"
            target="_blank"
                ...
                <td class="p-3 text-right">
                  <div class="inline-flex items-center gap-1">
                    ...
                    <Link
                      ...
                      :href="window.location.pathname + '/detail/' + row[primary_key]"
                    ...
                    <Link
                      ...
                      :href="window.location.pathname + '/edit/' + row[primary_key]"
