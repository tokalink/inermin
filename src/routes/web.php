...
Route::group([
    ...
    Route::post('/login', [InerminAuthController::class, 'postLogin'])->middleware('throttle:5,1');
    ...
    Route::group(['middleware' => [InerminAuthMiddleware::class]], function () {
        ...
        Route::post('/logout', [InerminAuthController::class, 'getLogout'])->name('inermin.logout');
        ...
        Route::post('/users/delete/{id}', [InerminUsersController::class, 'getDelete']);
        ...
        Route::post('/privileges/delete/{id}', [InerminPrivilegesController::class, 'getDelete']);
        ...
        Route::post('/menus/move-order/{id}/{direction}', [InerminMenusController::class, 'postMoveOrder']);
        ...
        Route::post('/menus/delete/{id}', [InerminMenusController::class, 'getDelete']);
        ...
        Route::post('/settings/delete-setting/{id}', [InerminSettingsController::class, 'getDeleteSetting']);
        Route::post('/settings/delete/{id}', [InerminSettingsController::class, 'getDelete']);
        ...
        Route::post('/modules/delete/{id}', [InerminModulsController::class, 'getDelete']);

        Route::get('/logs', [InerminLogsController::class, 'getIndex']);
        Route::post('/logs/delete/{id}', [InerminLogsController::class, 'getDelete']);
        ...
        Route::post('/api_generator/delete/{id}', [InerminApiController::class, 'getDelete']);
        ...
        Route::post('/email_templates/delete/{id}', [InerminEmailController::class, 'getDelete']);
        ...
        Route::post('/statistic_builder/delete/{id}', [InerminStatisticController::class, 'getDelete']);
        ...
        Route::post('/statistic_builder/delete-component/{id}', [InerminStatisticController::class, 'getDeleteComponent']);
    });
});
